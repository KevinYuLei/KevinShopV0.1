...
{
    public class GhSingleLinearFlightStairComponent : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public GhSingleLinearFlightStairComponent()
          : base(
                "SingleLinearFlightStair", 
                "单跑直行楼梯",
                "Create a single linear flight stair",
                "KevinShop", 
                "Stair"
                )
        {
